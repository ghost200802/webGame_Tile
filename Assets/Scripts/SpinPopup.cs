...
//                //WatchAds
//                WatchAds_Finished();
////                FirebaseManager.instance.LogShowReward("Spin");
//            }
//            else
//            {
//                lockGroup.gameObject.SetActive(false);
...
//        });
    ...
    public void WatchAds_Finished()
    {
        ...
        spinObj.transform.DORotate(new Vector3(0f, 0f, -4 * 360 - (8-indexResult) * 45), 5f).SetEase(Ease.InOutExpo).OnComplete(() =>
        {
            ...
            MenuManager.instance.OpenRewardPopup(new List<ConfigItemShopData>() { listSpinDatas[indexResult] });
    ...
    {
        MenuManager.instance.CloseShopSucces();
        gameObject.SetActive(false);
    }
    ...
    public void InitViews()
    {
        ...
        //Debug.Log("isRewardAds_Avaiable"+ Advertisements.Instance.IsRewardVideoAvailable());
